								...
								<div class="card-body">
									<form method="post" action="loginAction.jsp">
										<div class="form-floating mb-3">
											<input class="form-control" id="inputmember_name" type="text"
												placeholder="아이디" name="member_name" /> <label
												for="member_name">member_name</label>
										</div>
										<div class="form-floating mb-3">
											<input class="form-control" id="inputmember_id"
												type="password" placeholder="member_id" name="member_id" />
											<label for="inputmember_id">member_id</label>
										</div>
