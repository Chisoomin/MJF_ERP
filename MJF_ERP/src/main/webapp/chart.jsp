			...
			<form action="bill_loadpage.jsp" method="get"
				...
				<div class="card mb-4">
					...
					<div class="card-body">
						<table id="datatablesSimple">
							...
							<tbody>
								...
								try {
									...
									out.println("<tr>");
									out.println("<td nowrap align=\"center\"><input type=\"radio\" name=\"rdch\" value='"+sales_rs[b][19]+"'></td>");
									out.println("<td nowrap class=\"ct\">"+(b+1)+"</td>");
						...
						out.println("<button style=\"float: right;\" id=\"btn_val\" name=\"btn_val\" value=\"세금\" type=\"submit\" class=\"btn btn-set\">");
