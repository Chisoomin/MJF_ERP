...
try {
	...
	out.println("opener.document.getElementById('orderda').value ='" + order_rs[0][2] + "';");
	out.println("opener.document.getElementById('orderacc').value ='" + order_rs[0][5] + "';");
	out.println("opener.document.getElementById('orderaccnum').value ='" + order_rs[0][4] + "';");
	out.println("opener.document.getElementById('detail').value ='" + num + "';");
	
	out.println("opener.document.getElementById('chdate').innerText = '수주날짜';");
	...
	for (int n = 0; n < rowCount; n++) {
		...
		out.println("y.setAttribute(\"value\", \"" + order_rs[n][17] + "\");");
		...
		out.println("z.setAttribute(\"value\", \"" + order_rs[n][16] + "\");");
		...
		out.println("a.setAttribute(\"value\", \"" + order_rs[n][6] + "\");");
		...
		out.println("b.setAttribute(\"value\", \"" + order_rs[n][7] + "\");");
		...
		out.println("c.setAttribute(\"value\", \"" + order_rs[n][8] + "\");");
		...
		out.println("d.setAttribute(\"value\", \"" + order_rs[n][9] + "\");");
		...
		out.println("e.setAttribute(\"value\", \"" + order_rs[n][10] + "\");");
		...
		out.println("f.setAttribute(\"type\", \"number\");");
		...
		out.println("f.setAttribute(\"value\", \"" + order_rs[n][11] + "\");");
		...
		out.println("g.setAttribute(\"value\", \"" + order_rs[n][12] + "\");");
		...
		out.println("h.setAttribute(\"value\", \"" + order_rs[n][13] + "\");");
		...
		out.println("i.setAttribute(\"value\", \"" + order_rs[n][14] + "\");");
		...
		total += Integer.parseInt(order_rs[n][14]);
		if (n == rowCount - 1) {
			...
			out.println("j.setAttribute(\"value\", \"\");");
			...
			out.println("j.setAttribute(\"readonly\", \"readonly\");");
			out.println("newCell" + n + "13.append(j)");
			//out.println("newCell" + n + "13.innerText = \"\";");
		}
