					...
					<form action="resign_process.jsp" method="get"
						...
						<div class="card mb-4">
							...
							<div class="card-body">
								<table id="datatablesSimple">
									...
									<tbody>
										...
										try {
											...
											String memrs[][] = new String[rowCount][9];
											rs2.first();
											...
											for (int b = 0; b < rowCount; b++) {
												...
												out.println("<td nowrap>" + memrs[b][8] + "</td>");
												if(memrs[b][7] == null){
								...
								<%
								out.println(
										"<div style=\"margin-top:15px;\"><button style= \"margin-left:20px; float: right;\" id=\"btn_val\" name=\"btn_val\" value=\"퇴사\" type=\"submit\" class=\"btn btn-set\">");
