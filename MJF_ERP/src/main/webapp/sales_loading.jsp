	...
	<div class="container">
		<div class="input-form-backgroud row">
			<div class="input-form col-md-12 mx-auto">
				<form action="process_sa.jsp" method="get" id = "good"
					class="validation-form" novalidate>
					<div class="card mb-4">
						<div class="card-header">
							<i class="fas fa-table me-1"></i>SALES LIST
						</div>
						<div class="card-body">
							<table id="datatablesSimple">
								...
								<tbody>
									<%
									try {
										String sql = "SELECT order_num, sales_date, account_name, product_name, count(tading_code), total_amount from MJFdb.sales_table where product_quantity>0 and sales_note is null group by tading_code";
										...
										for (int k = 0; k < rowCount; k++) {						
											...
											out.println("<tr>");
											out.println("<td class='ct'><input type='radio' id='" + order_rs[k][0] + "' name='radiocheck_ban' value='" + order_rs[k][0] + "'/>" + (k+1)
											+ "</td>");
