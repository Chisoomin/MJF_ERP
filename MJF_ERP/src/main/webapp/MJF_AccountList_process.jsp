...
<body>
	...
	<div class="container">
		<div class="input-form-backgroud row">
			<div class="input-form col-md-12 mx-auto">
				<form action="process_or.jsp" method="post"
								...
								<tbody>
									...
									try {
										...
										for (int k = 0; k < rowCount; k++) {
											out.println("<tr>");
											out.println("<td class='ct'><input type='radio' id='" + k + "' name='radiocheck' value='" + k + "'/>" + (k + 1)
											+ "</td>");
											...
											out.println("<th>" + order_rs[k][8] + "</th>");
											out.println("</tr>");
										}
									} catch (SQLException ex) {
										out.println("SQLException " + ex.getMessage());
	...
	<script type="text/javascript">
		...
		function getParentText() {
			opener.document.getElementById('ordernum').value = document.getElementById('1').value;
			window.close();
		}
	</script> -->
