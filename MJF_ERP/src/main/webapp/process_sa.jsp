...
int columnCount = 0;
int rowCount = 0;
String sujunum = request.getParameter("radiocheck_ban");
...
try {
	String sql = "SELECT * from MJFdb.sales_table where order_num='" + sujunum + "' and product_quantity>0 and sales_note is null";
	...
	out.println("opener.document.getElementById('ordernumber_ban').value ='" + order_rs[0][1] + "';");
	out.println("opener.document.getElementById('orderda_ban').value ='" + order_rs[0][4] + "';");
	out.println("opener.document.getElementById('orderacc_ban').value ='" + order_rs[0][6] + "';");
	out.println("opener.document.getElementById('orderaccnum_ban').value ='" + order_rs[0][5] + "';");
	out.println("opener.document.getElementById('detail').value ='" + num + "';");

	out.println("opener.document.getElementById('ch_main_ban').checked = true;");

	int total = 0;

	//테이블에 추가
	out.println("const table = opener.document.getElementById('orderlist_ban');");
	//테이블 초기화
	...
	for (int n = 0; n < rowCount; n++) {
		...
		out.println("x.setAttribute(\"name\", \"ch_ban\");");
		...
		out.println("y.setAttribute(\"name\", \"memname_ban" + n + "\");");
		out.println("y.setAttribute(\"id\", \"memname_ban" + n + "\");");
		...
		out.println("z.setAttribute(\"name\", \"memnumber_ban" + n + "\");");
		out.println("z.setAttribute(\"id\", \"memnumber_ban" + n + "\");");
		...
		out.println("a.setAttribute(\"name\", \"procode_ban" + n + "\");");
		out.println("a.setAttribute(\"id\", \"procode_ban" + n + "\");");
		...
		out.println("b.setAttribute(\"name\", \"proname_ban" + n + "\");");
		out.println("b.setAttribute(\"id\", \"proname_ban" + n + "\");");
		...
		out.println("c.setAttribute(\"name\", \"procolor_ban" + n + "\");");
		out.println("c.setAttribute(\"id\", \"procolor_ban" + n + "\");");
		...
		out.println("d.setAttribute(\"name\", \"prodan_ban" + n + "\");");
		out.println("d.setAttribute(\"id\", \"prodan_ban" + n + "\");");
		...
		int quan = Integer.parseInt(order_rs[n][11]);
		out.println("var e = document.createElement(\"INPUT\");");
		out.println("e.setAttribute(\"type\", \"number\");");
		out.println("e.setAttribute(\"min\", 1);");
		out.println("e.setAttribute(\"max\", "+quan+");");
		out.println("e.setAttribute('onChange', 'chgprice2(this.id);');");
		out.println("e.setAttribute(\"class\", \"table-input-style\");");
		out.println("e.setAttribute(\"name\", \"prosu_ban" + n + "\");");
		out.println("e.setAttribute(\"id\", \"prosu_ban" + n + "\");");
		out.println("e.setAttribute(\"value\", \"" + order_rs[n][11] + "\");");
		...
		out.println("f.setAttribute(\"name\", \"proprice_ban" + n + "\");");
		out.println("f.setAttribute(\"id\", \"proprice_ban" + n + "\");");
		...
		out.println("g.setAttribute(\"name\", \"orsup_ban" + n + "\");");
		out.println("g.setAttribute(\"id\", \"orsup_ban" + n + "\");");
		out.println("g.setAttribute(\"value\", \"" + order_rs[n][13] + "\");");
		...
		out.println("h.setAttribute(\"name\", \"orvat_ban" + n + "\");");
		out.println("h.setAttribute(\"id\", \"orvat_ban" + n + "\");");
		out.println("h.setAttribute(\"value\", \"" + order_rs[n][14] + "\");");
		...
		out.println("i.setAttribute(\"name\", \"orall_ban" + n + "\");");
		out.println("i.setAttribute(\"id\", \"orall_ban" + n + "\");");
		out.println("i.setAttribute(\"value\", \"" + order_rs[n][15] + "\");");
		...
		out.println("j.setAttribute(\"name\", \"onote_ban" + n + "\");");
		out.println("j.setAttribute(\"id\", \"onote_ban" + n + "\");");
		//out.println("j.setAttribute(\"value\", \"" + total + "\");");
		out.println("j.setAttribute(\"value\", \"반품\");");
