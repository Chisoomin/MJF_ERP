...
String sql = "SELECT *, COUNT(order_num) FROM order_table WHERE delivery_date between date('" + startDate + "') and date('" + endDate + "') GROUP BY order_num HAVING COUNT(order_num) > 0;";
